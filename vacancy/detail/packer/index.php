      ...
      <div class="container">
        <div class="row">
          <div class="col-100">
            ...
            <h3 class="subtitle">Упаковщик на производство</h3>
          </div>
        </div>
      </div>
    </div>
      ...
      <article class="col-100 item-detail">
        ...
        <div class="description bg-white">
          ...
          <div class="description-block">
            ...
            <p>Уровень зарплаты: от 50 000 до 60 000 рублей</p>
          ...
          <div class="description-block">
            <h4>Обязанности:</h4>
            <p>Упаковка товара в зависимости от его качеств, условий эксплуатации и перевозки</p>
            <p>Фасовка, укладка</p>
            <p>Проверка целостность упаковки</p>
            <p>Использовать технические средства при упаковке товаров</p>
            <p>Выполнение поставленных задач</p>
          </div>
          <div class="description-block">
            <h4>Требования к кандидату:</h4>
            <p>Навыки работы с электроинструментом</p>
            <p>Навыки чтение чертежей</p>
          </div>
          <div class="description-epilog mt-05">
            <p>У нас ты получишь не только профессиональное обучение, но и возможность реализовать свой потенциал в
              динамичной и перспективной отрасли. Присоединяйся к нашей команде и стань частью увлекательного мира
              металла!
