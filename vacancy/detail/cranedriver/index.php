      ...
      <div class="container">
        <div class="row">
          <div class="col-100">
            ...
            <h3 class="subtitle">Машинист крана</h3>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-center--lg">
      <article class="col-100 item-detail">
        ...
        <div class="description bg-white">
          ...
          <div class="description-block">
            <h4>Обязанности:</h4>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque velit rem tempore!</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit exercitationem id assumenda iusto quaerat,
              corporis molestias quas corrupti natus consequuntur esse ducimus!</p>
          </div>
          <div class="description-block">
            <h4>Требования к кандидату:</h4>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque velit rem tempore!</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit exercitationem id assumenda iusto
              quaerat,
              corporis molestias quas corrupti natus consequuntur esse ducimus!</p>
          </div>
          <div class="description-epilog mt-05">
            <p>У нас ты получишь возможность реализовать свой потенциал в динамичной и
              перспективной отрасли. Присоединяйся к нашей команде и стань частью увлекательного мира металла!
